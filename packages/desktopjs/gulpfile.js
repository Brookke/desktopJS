...
gulp.task('watch', () => gulp.watch(['src/**/*.*', 'tests/**/*.*', '*.json', '*.js'], { ignoreInitial: true, delay: 1000 }, gulp.series('eslint', gulp.parallel(['build:main', 'test']), gulp.parallel(['dts', 'compress']))));
